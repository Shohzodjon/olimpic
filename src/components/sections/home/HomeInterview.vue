        ...
        <div class="container">
            ...
            <a-row :gutter="[20, 0]" v-if="isLoad">
                <a-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
                    <HomeGallery :img="interviewStore.listLimit[0].images[0]" :title="interviewStore.listLimit[0].title"
                        :time="interviewStore.listLimit[0].created_at" :url="`/${lang}/news-slug/11`"
                ...
                <a-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12" class="home-interview-section__right-side">
                    <span v-for="(item, i) in interviewStore.listLimit" :key="item.id" v-show="i != 0">
                        <HomeGallery :img="item.images[0]" :title="item.title" :url="`/${lang}/news-slug/${item.id}`"
